...
### També he modificat el fitxer de configuració amb el nom my.cnf i ha quedat d’aquesta manera, després de posar aquesta configuració he fet les comandes de canviar  de directori, aturar i iniciar el servei mysql:
